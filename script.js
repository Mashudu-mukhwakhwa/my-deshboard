...
// Sayfa yüklendiginde ve boyut degisimlerinde sidebar durumunu ayarlama
function adjustSidebar() {
    if (window.innerWidth <= 576) {
        sidebar.classList.add('hide');  // 576px ve alti için sidebar gizli
...
// Sayfa yüklendiginde ve pencere boyutu degistiginde sidebar durumunu ayarlama
...
// Menülerin açilip kapanmasi için fonksiyon
    function toggleMenu(menuId) {
      var menu = document.getElementById(menuId);
      var allMenus = document.querySelectorAll('.menu');

      // Diger tüm menüleri kapat
      ...
      // Tiklanan menü varsa aç, yoksa kapat
    ...
    // Baslangiçta tüm menüleri kapali tut
